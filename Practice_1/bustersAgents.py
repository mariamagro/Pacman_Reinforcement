...
class BasicAgentAA(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        move = self.weka.predict("shortest_distances_model.model", x, "shortest_distance_raw_data.arff")
    ...
    def printLineData(self, gameState):
        ...
        if not os.path.isfile("distance_raw_data.arff"):
            ...
            attributes = ("@relation distance_raw_data\n"
                          ...
                          "@attribute 'South' numeric\n"
                          "@attribute 'East' numeric\n"
    ...
    def getstate(self, gameState):
        ...
        info = [str(North), str(South), str(East), str(West), pacmanup, pacmandown, pacmanright, pacmanleft]
